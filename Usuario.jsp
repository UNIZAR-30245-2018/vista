...
<%
    ...
    if(feed != null) {
        publicaciones = fachada.getPublicacionesOfSeguidos(usuario.getSeudonimo());
        System.out.println("Solo los seguidos");
    }
    else {
        publicaciones = fachada.getPublicaciones();
    ...
    System.out.println("Seguidos" + numeroSeguidores);
    System.out.println("Seguidores" + numeroSeguidos);
    ...
    <div class="container" style="width:inherit;justify-content:space-around;">
        <div class="row" style="width:inherit;text-align: center; ;justify-content:space-around;">
            <div class="col-md-6" style="width:inherit;align-self:center;border:1px solid blue;border-radius:12px;">
                <a href="./Usuario.jsp?feed=1" class="button"  name ="user" class="navbar-toggler" data-toggle="collapse" data-target="#navcol-1">Ver feed de seguidos</a>
                <a href="./Usuario.jsp" class="button"  name ="user" class="navbar-toggler" data-toggle="collapse" data-target="#navcol-1">Ver toda la feed</a>
            </div>
        </div>
    </div>
</div>
    ...
    <ul class="list-group" style="margin-top:10%;float:inherit;width:50%;margin-left:45%;">
        <li class="list-group-item">
            <div class="media"><img class="mr-3">
                <form id="enterText" action="addJuegoAPub.do" method="post" class="form-horizontal" role="form">
